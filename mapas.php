        ...
        <div class="topbar">
            ...
            <div class="page-title">
                <h1 class="section-title">
                    Mapas Educativos - <?php echo formatearNombreMunicipio($municipioSeleccionado); ?>
                </h1>
            </div>
            <div class="utilities">
            ...
            <div class="panel-body">
                <?php if ($tieneMapaDisponible): ?>
                    <div id="map-container" class="map-container">
                        <iframe id="map-iframe" src="<?php echo htmlspecialchars($urlMapaIframe, ENT_QUOTES, 'UTF-8'); ?>"
