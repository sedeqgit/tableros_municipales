...
<BODY>
    ...
    function filas_conteo($css, $arr_datos)
    {
        ...
        // Verifica que ni pub ni tot sean cero
        if ($arr_datos["pub"] == 0 || $arr_datos["tot"] == 0) {
            echo "<TD ALIGN='CENTER' VALIGN='CENTER' CLASS='" . $css . "'>-</TD>";
        } else {
            echo "<TD ALIGN='CENTER' VALIGN='CENTER' CLASS='" . $css . "'>" . number_format((($arr_datos["pub"] / $arr_datos["tot"]) * 100), 1, '.', ',') . "</TD>";
        }
        // Verifica que ni priv ni tot sean cero
        if ($arr_datos["priv"] == 0 || $arr_datos["tot"] == 0) {
            echo "<TD ALIGN='CENTER' VALIGN='CENTER' CLASS='" . $css . "'>-</TD>";
        } else {
    ...
    function filas_hm($css, $arr_datos)
    {
        ...
        // Aquí está el problema - necesitamos verificar que tot != 0 antes de dividir
        if ($arr_datos["pub"] == 0 || $arr_datos["tot"] == 0) {
            echo "<TD ALIGN='CENTER' VALIGN='CENTER' CLASS='" . $css . "'>-</TD>";
        } else {
            echo "<TD ALIGN='CENTER' VALIGN='CENTER' CLASS='" . $css . "'>" . number_format((($arr_datos["pub"] / $arr_datos["tot"]) * 100), 1, '.', ',') . "</TD>";
        ...
        // También aquí necesitamos verificar
        if ($arr_datos["h_tot"] == 0 || $arr_datos["tot"] == 0) {
            echo "<TD ALIGN='CENTER' VALIGN='CENTER' CLASS='" . $css . "'>-</TD>";
        } else {
            echo "<TD ALIGN='CENTER' VALIGN='CENTER' CLASS='" . $css . "'>" . number_format((($arr_datos["h_tot"] / $arr_datos["tot"]) * 100), 1, '.', ',') . "</TD>";
        }
        // Y aquí
        if ($arr_datos["m_tot"] == 0 || $arr_datos["tot"] == 0) {
            echo "<TD ALIGN='CENTER' VALIGN='CENTER' CLASS='" . $css . "'>-</TD>";
        } else {
    ...
    function mostrar_subnivel($css, $ini_ciclo, $cv_mun, $municipio, $subnivel, $esc, $alum, $doc, $grp, $aula, $disc, $hl, $g1ro, $g2do, $g3ro, $egre, $usaer, $nextj, $ormisma, $orotra, $orpais, $ortotal)
    {
        ...
        echo "<TD VALIGN='center' CLASS='" . $css . "'>PREESCOLAR</TD>";
    ...
    function prim_qr($dato, $subnivel, $ini_ciclo, $cv_mun)
    {
        ...
        if ((strcmp($dato, "ALUMNO")) == 0) {
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_alum = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v177)AS totales,
										SUM(v165)AS h,SUM(v171)AS m
										FROM nonce_pano_" . $ini_ciclo . ".pree_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_alum = "SELECT cv_mun,c_nom_mun AS MUNICIPIO,subcontrol,control, SUM(v97)AS totales,
										SUM(v85)AS h,SUM(v91)AS m
										FROM nonce_pano_" . $ini_ciclo . ".pree_comuni_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "DOCENTE")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_doc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v909)AS totales,
											SUM(v859+v867)AS h,SUM(v860+v868)AS m
											FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_doc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v841)AS totales,
											SUM(v795+v803+v805)AS h,SUM(v796+v804+v806)AS m
											FROM nonce_pano_" . $ini_ciclo . ".pree_ind_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_doc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v151)AS totales,
											SUM(v149)AS h,SUM(v150)AS m
											FROM nonce_pano_" . $ini_ciclo . ".pree_comuni_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "GRUPO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_gpr = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v182)AS totales
											FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_gpr = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v182)AS totales
											FROM nonce_pano_" . $ini_ciclo . ".pree_ind_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "AULA")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_aula = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v935)AS cat1,
											SUM(v940)AS cat2,SUM(v945)AS cat3
											FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_aula = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v864)AS cat1,
											SUM(v869)AS cat2,SUM(v874)AS cat3
											FROM nonce_pano_" . $ini_ciclo . ".pree_ind_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_aula = "SELECT cv_mun,c_nom_mun AS MUNICIPIO,subcontrol,control, SUM(v151)AS cat1,
											SUM(v151)AS cat2,SUM(v151)AS cat3
											FROM nonce_pano_" . $ini_ciclo . ".pree_comuni_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "DISCAP")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_disc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v423)AS totales,
											SUM(v421)AS h,SUM(v422)AS m
											FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_disc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v386)AS totales,
											SUM(v384)AS h,SUM(v385)AS m
											FROM nonce_pano_" . $ini_ciclo . ".pree_ind_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_disc = "SELECT cv_mun,c_nom_mun AS MUNICIPIO,subcontrol,control,SUM(v148)AS totales,
											SUM(v146)AS h,SUM(v147)AS m
											FROM nonce_pano_" . $ini_ciclo . ".pree_comuni_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "HL")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_hl = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v189)AS totales,
											SUM(v187)AS h,SUM(v188)AS m
											FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_hl = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v416+v421+v426+v431+v435+v439) AS totales,
        ...
        if ((strcmp($dato, "PRIMERO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v138)AS totales,
										SUM(v126)AS h,SUM(v132)AS m
										FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_alum = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v138)AS totales,
										SUM(v126)AS h,SUM(v132)AS m
										FROM nonce_pano_" . $ini_ciclo . ".pree_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_alum = "SELECT cv_mun,c_nom_mun AS MUNICIPIO,subcontrol,control, 0 AS totales,
                                        0 AS h, 0 AS m
                                        FROM nonce_pano_" . $ini_ciclo . ".pree_comuni_" . $ini_ciclo . " 
                                        WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
                                        GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        if ((strcmp($dato, "SEGUNDO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v150)AS totales,
										SUM(v142)AS h,SUM(v146)AS m
										FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_alum = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v150)AS totales,
										SUM(v142)AS h,SUM(v146)AS m
										FROM nonce_pano_" . $ini_ciclo . ".pree_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        if ((strcmp($dato, "TERCERO")) == 0) {
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_alum = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v159)AS totales,
										SUM(v142)AS h,SUM(v146)AS m
										FROM nonce_pano_" . $ini_ciclo . ".pree_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        if ((strcmp($dato, "USAER")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_usaer = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v219)AS totales,
											SUM(v217)AS h,SUM(v218)AS m
											FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "NEXTJ")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_nextj = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v216)AS totales,
											SUM(v214)AS h,SUM(v215)AS m
											FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "ORMISMA")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v77+v78)AS totales,
										SUM(v77)AS h,SUM(v78)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v77+v78)AS totales,
										SUM(v77)AS h,SUM(v78)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".pree_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        if ((strcmp($dato, "OROTRA")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v79+V80)AS totales,
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v79+v80)AS totales,
										SUM(v79)AS h,SUM(v80)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".pree_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        if ((strcmp($dato, "ORPAIS")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v81+v82)AS totales,
										SUM(v81)AS h,SUM(v80)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v81+v82)AS totales,
        ...
        if ((strcmp($dato, "ORTOTAL")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v83+v84)AS totales,
										SUM(v83)AS h,SUM(v84)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".pree_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v83+v84)AS totales,
										SUM(v83)AS h,SUM(v84)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".pree_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
    ...
    function primaria_estadistica($link, $ini_ciclo)
    {
        ...
        while ($row_lista_muni = pg_fetch_assoc($rs_lista_muni)) {
            ...
            mostrar_subnivel("datos_subnivel", $ini_ciclo, $cv_mun, $municipio, "COMU", $esc_comu, $alum_comu, $doc_comu, $grp_comu, $aula_comu, $disc_comu, $hl_comu, $g1ro_comu, $g2do_comu, $g3ro_comu, $egre_comu, $usaer_comu, $nextj_comu, $ormisma_comu, $orotra_comu, $orpais_comu, $ortotal_comu);
    ...
    <script>
        ...
        const columnasIndices = {
            ...
            'egresados': { inicio: 87, fin: 96 },      // 10 columnas (antes 117-126)
            'usaer': { inicio: 97, fin: 106 },         // 10 columnas (antes 127-136)
            'nextj': { inicio: 107, fin: 116 },        // 10 columnas (antes 137-146)
            'ormisma': { inicio: 117, fin: 126 },      // 10 columnas (antes 147-156)
            'orotra': { inicio: 127, fin: 136 },       // 10 columnas (antes 157-166)
            'orpais': { inicio: 137, fin: 146 },       // 10 columnas (antes 167-176)
            'ortotal': { inicio: 147, fin: 156 }       // 10 columnas (antes 177-186)
        };
