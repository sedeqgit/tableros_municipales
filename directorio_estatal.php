                        ...
                        <div class="stats-row">
                            ...
                            <div class="stat-box animate-fade delay-2">
                                <div class="stat-value">
                                    <span
                                        class="public-schools"><?php echo number_format($totalEscuelasPublicas); ?></span>
                        ...
                        <div class="directorio-filters">
                            ...
                            <div class="export-buttons">
                                ...
                                <button class="export-btn export-pdf"
                                    onclick="exportarDirectorioEstatal('pdf', 'publicas')" title="Exportar a PDF">
                    ...
                    <div class="matricula-body">
                        <div class="directorio-filters">
                            ...
                            <div class="export-buttons">
                                ...
                                <button class="export-btn export-pdf"
                                    onclick="exportarDirectorioEstatal('pdf', 'privadas')" title="Exportar a PDF">
                                    <i class="fas fa-file-pdf"></i> PDF
                                </button>
                            </div>
                            <div class="school-count">
