...
<HEAD>
    ...
    <TITLE>Inicial No Escolarizado</TITLE>
    <style>
        .filtro-container {
            margin: 15px 0;
            padding: 10px;
...
<BODY>
    <div class="filtro-container">
        ...
        <select id="subnivelFilter">
            ...
            <option value="NE">No Escolarizado</option>
            <option value="COMU">Comunitario</option>
        ...
        <select id="columnaFilter">
            ...
            <option value="lactante">Menos de un año</option>
            <option value="maternal">1 año</option>
            <option value="preescolar">2 años</option>
            <option value="egreso">3 años</option>
            <option value="cuarto">4 años</option>
    ...
    {
        $nom_subnivel = "";
        if ((strcmp($subnivel, "NE")) == 0) {
            $nom_subnivel = "NO ESCOLARIZADO";
        }
    ...
    function mostrar_subnivel($css, $ini_ciclo, $cv_mun, $municipio, $subnivel, $esc, $alum, $doc, $grp, $aula, $disc, $hl, $glact, $gmat, $gpree, $egre, $usaer, $nextj, $ormisma, $orotra, $orpais, $ortotal)
    {
        ...
        echo "<TD VALIGN='center' CLASS='" . $css . "'>INICIAL NO ESCOLARIZADO</TD>";
    ...
    function prim_qr($dato, $subnivel, $ini_ciclo, $cv_mun)
    {
        ...
        //Por cuestiones de tiempo y eficiencia, se dejarán GRAL e IND, pero los codigos v### harán referencia a NE y COMU respectivamente
        $qr_prim_hm = "";
        ...
        if ((strcmp($dato, "ALUMNO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(V129 + V130)AS totales,
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_alum = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(V79 + V80)AS totales,
        ...
        if ((strcmp($dato, "DOCENTE")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_doc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(V183+v184)AS totales,
					SUM(V183)AS h,
					SUM(V184)AS m
											FROM nonce_pano_" . $ini_ciclo . ".ini_ne_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_doc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v124 + V125)AS totales,
											SUM(v124)AS h,SUM(v125)AS m
											FROM nonce_pano_" . $ini_ciclo . ".ini_comuni_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "GRUPO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_gpr = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,0 AS totales 
											FROM nonce_pano_" . $ini_ciclo . ".ini_ne_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_gpr = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,0 AS totales 
											FROM nonce_pano_" . $ini_ciclo . ".ini_comuni_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "AULA")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_aula = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v295)AS cat1,
											0 AS cat2,0 AS cat3
											FROM nonce_pano_" . $ini_ciclo . ".ini_ne_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_aula = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v127+v128+v129+v130+v131+v132)AS cat1,
											0 AS cat2,0 AS cat3
											FROM nonce_pano_" . $ini_ciclo . ".ini_comuni_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        if ((strcmp($dato, "DISCAP")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_disc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(V169)AS totales,
											SUM(v167)AS h,SUM(v168)AS m
											FROM nonce_pano_" . $ini_ciclo . ".ini_ne_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_disc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v117)AS totales,
											SUM(v115)AS h,SUM(v116)AS m
											FROM nonce_pano_" . $ini_ciclo . ".ini_comuni_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "HL")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_hl = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v49)AS totales,
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_hl = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(V55) AS totales,
											SUM(0)AS h,SUM(0)AS m 		
											FROM nonce_pano_" . $ini_ciclo . ".ini_comuni_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        /**==========================================================================================  
                                                                                                                                                                                                                          =========  GRADOS
                                                                                                                                                                                                                          ==========================================================================================*/
        if ((strcmp($dato, "MENOS_UN_AÑO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v119+v120)AS totales,
										SUM(v119)AS h,SUM(v120)AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_ne_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_alum = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control, sum(v66) AS totales,
										sum(v64) AS h,sum(v65) AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_comuni_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "1_AÑO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v121+v122)AS totales,
										SUM(v121)AS h,SUM(v122)AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_ne_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_alum = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,sum(v69) AS totales,
										sum(v67) AS h,sum(v68) AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_comuni_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "2_AÑOS")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v123+v124)AS totales,
										SUM(v123)AS h,SUM(v124)AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_ne_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_alum = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,sum(v72) AS totales,
										sum(v70) AS h,sum(v72) AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_comuni_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "3_AÑOS")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_egre = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control,sum(v125+v126) AS totales,
										sum(v125) AS h, sum(v126) AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_ne_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_egre = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,sum(v75) AS totales,
										sum(v73) AS h, 0 AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_comuni_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        if ((strcmp($dato, "4_AÑOS")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_egre = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control,sum(v127+v128) AS totales,
										0 AS h, 0 AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_ne_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_egre = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,sum(v78) AS totales,
										sum(v76) AS h, sum(v77) AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_comuni_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "USAER")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_usaer = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,0 AS totales,
											0 AS h,0 AS m
											FROM nonce_pano_" . $ini_ciclo . ".ini_ne_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        if ((strcmp($dato, "NEXTJ")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_nextj = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v163)AS totales,
											SUM(v161)AS h,SUM(v162)AS m
        ...
        if ((strcmp($dato, "ORMISMA")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v129+v130)AS totales,
										SUM(v129)AS h,SUM(v130)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v752+v753)AS totales,
										SUM(v752)AS h,SUM(v753)AS m 
        ...
        if ((strcmp($dato, "OROTRA")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v131+v132)AS totales,
										SUM(v131)AS h,SUM(v132)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v754+v755)AS totales,
										SUM(v754)AS h,SUM(v755)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".ini_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "ORPAIS")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v133+V134)AS totales,
										SUM(v133)AS h,SUM(v134)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v756+v757)AS totales,
										SUM(v756)AS h,SUM(v757)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".ini_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "ORTOTAL")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v135+v136)AS totales,
										SUM(v135)AS h,SUM(v136)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v758+v759)AS totales,
										SUM(v758)AS h,SUM(v759)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".ini_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
    ...
    function prim_conteo_muni($cv_mun, $municipio, $gral, $ind)
    {
...
FROM nonce_pano_" . $ini_ciclo . ".prim_gral_" . $ini_ciclo . " 
        ...
        while ($row_lista_muni = pg_fetch_assoc($rs_lista_muni)) {
            ...
            $esc_ne = prim_conteo($link, "ESCUELA", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $alum_ne = prim_hm($link, "ALUMNO", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $doc_ne = prim_hm($link, "DOCENTE", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $grp_ne = prim_conteo($link, "GRUPO", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $aula_ne = prim_categ($link, "AULA", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $disc_ne = prim_hm($link, "DISCAP", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $hl_ne = prim_hm($link, "HL", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $gm1ro_ne = prim_hm($link, "MENOS_UN_AÑO", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $g1ro_ne = prim_hm($link, "1_AÑO", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $g2do_ne = prim_hm($link, "2_AÑOS", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $g3ro_ne = prim_hm($link, "3_AÑOS", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $g4ro_ne = prim_hm($link, "4_AÑOS", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $usaer_ne = prim_hm($link, "USAER", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $nextj_ne = prim_hm($link, "NEXTJ", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $ormisma_ne = prim_hm($link, "ORMISMA", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $orotra_ne = prim_hm($link, "OROTRA", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $orpais_ne = prim_hm($link, "ORPAIS", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $ortotal_ne = prim_hm($link, "ORTOTAL", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            // Cambiado "GRAL" por "NE" para que coincida con el filtro
            mostrar_subnivel("datos_subnivel", $ini_ciclo, $cv_mun, $municipio, "NE", $esc_ne, $alum_ne, $doc_ne, $grp_ne, $aula_ne, $disc_ne, $hl_ne, $gm1ro_ne, $g1ro_ne, $g2do_ne, $g3ro_ne, $g4ro_ne, $usaer_ne, $nextj_ne, $ormisma_ne, $orotra_ne, $orpais_ne, $ortotal_ne);

            $esc_comu = prim_conteo($link, "ESCUELA", "IND", $ini_ciclo, $cv_mun, $municipio);
            $alum_comu = prim_hm($link, "ALUMNO", "IND", $ini_ciclo, $cv_mun, $municipio);
            $doc_comu = prim_hm($link, "DOCENTE", "IND", $ini_ciclo, $cv_mun, $municipio);
            $grp_comu = prim_conteo($link, "GRUPO", "IND", $ini_ciclo, $cv_mun, $municipio);
            $aula_comu = prim_categ($link, "AULA", "IND", $ini_ciclo, $cv_mun, $municipio);
            $disc_comu = prim_hm($link, "DISCAP", "IND", $ini_ciclo, $cv_mun, $municipio);
            $hl_comu = prim_hm($link, "HL", "IND", $ini_ciclo, $cv_mun, $municipio);
            $gm1ro_comu = prim_hm($link, "MENOS_UN_AÑO", "IND", $ini_ciclo, $cv_mun, $municipio);
            $g1ro_comu = prim_hm($link, "1_AÑO", "IND", $ini_ciclo, $cv_mun, $municipio);
            $g2do_comu = prim_hm($link, "2_AÑOS", "IND", $ini_ciclo, $cv_mun, $municipio);
            $g3ro_comu = prim_hm($link, "3_AÑOS", "IND", $ini_ciclo, $cv_mun, $municipio);
            $g4ro_comu = prim_hm($link, "4_AÑOS", "IND", $ini_ciclo, $cv_mun, $municipio);
            $usaer_comu = sin_datos_hm($cv_mun, $municipio);
            $nextj_comu = sin_datos_hm($cv_mun, $municipio);
            $ormisma_comu = prim_hm($link, "ORMISMA", "IND", $ini_ciclo, $cv_mun, $municipio);
            $orotra_comu = prim_hm($link, "OROTRA", "IND", $ini_ciclo, $cv_mun, $municipio);
            $orpais_comu = prim_hm($link, "ORPAIS", "IND", $ini_ciclo, $cv_mun, $municipio);
            $ortotal_comu = prim_hm($link, "ORTOTAL", "IND", $ini_ciclo, $cv_mun, $municipio);
            // Cambiado "IND" por "COMU" para que coincida con el filtro
            mostrar_subnivel("datos_subnivel", $ini_ciclo, $cv_mun, $municipio, "COMU", $esc_comu, $alum_comu, $doc_comu, $grp_comu, $aula_comu, $disc_comu, $hl_comu, $gm1ro_comu, $g1ro_comu, $g2do_comu, $g3ro_comu, $g4ro_comu, $usaer_comu, $nextj_comu, $ormisma_comu, $orotra_comu, $orpais_comu, $ortotal_comu);

            $tot_esc_muni = prim_conteo_muni($cv_mun, $municipio, $esc_ne, $esc_comu);
            $tot_alum_muni = prim_hm_muni($cv_mun, $municipio, $alum_ne, $alum_comu);
            $tot_doc_muni = prim_hm_muni($cv_mun, $municipio, $doc_ne, $doc_comu);
            $tot_grp_muni = prim_conteo_muni($cv_mun, $municipio, $grp_ne, $grp_comu);
            $tot_aula_muni = prim_categ_muni($cv_mun, $municipio, $aula_ne, $aula_comu);
            $tot_disc_muni = prim_hm_muni($cv_mun, $municipio, $disc_ne, $disc_comu);
            $tot_hl_muni = prim_hm_muni($cv_mun, $municipio, $hl_ne, $hl_comu);
            $tot_gm1ro_muni = prim_hm_muni($cv_mun, $municipio, $gm1ro_ne, $gm1ro_comu);
            $tot_g1ro_muni = prim_hm_muni($cv_mun, $municipio, $g1ro_ne, $g1ro_comu);
            $tot_g2do_muni = prim_hm_muni($cv_mun, $municipio, $g2do_ne, $g2do_comu);
            $tot_g3ro_muni = prim_hm_muni($cv_mun, $municipio, $g3ro_ne, $g3ro_comu);
            $tot_egre_muni = prim_hm_muni($cv_mun, $municipio, $g4ro_ne, $g4ro_comu);
            $tot_usaer_muni = prim_hm_muni($cv_mun, $municipio, $usaer_ne, $usaer_comu);
            $tot_nextj_muni = prim_hm_muni($cv_mun, $municipio, $nextj_ne, $nextj_comu);
            $tot_ormisma_muni = prim_hm_muni($cv_mun, $municipio, $ormisma_ne, $ormisma_comu);
            $tot_orotra_muni = prim_hm_muni($cv_mun, $municipio, $orotra_ne, $orotra_comu);
            $tot_orpais_muni = prim_hm_muni($cv_mun, $municipio, $orpais_ne, $orpais_comu);
            $tot_ortotal_muni = prim_hm_muni($cv_mun, $municipio, $ortotal_ne, $ortotal_comu);
            mostrar_subnivel("total_muni", $ini_ciclo, $cv_mun, $municipio, "TOT", $tot_esc_muni, $tot_alum_muni, $tot_doc_muni, $tot_grp_muni, $tot_aula_muni, $tot_disc_muni, $tot_hl_muni, $tot_gm1ro_muni, $tot_g1ro_muni, $tot_g2do_muni, $tot_g3ro_muni, $tot_egre_muni, $tot_usaer_muni, $tot_nextj_muni, $tot_ormisma_muni, $tot_orotra_muni, $tot_orpais_muni, $tot_ortotal_muni);
        }
    }
    ...
    <script>
        ...
        const columnasIndices = {
            ...
            'lactante': { inicio: 57, fin: 66 },       // 10 columnas (Menos de un año)
            'maternal': { inicio: 67, fin: 76 },       // 10 columnas (1 año)
            'preescolar': { inicio: 77, fin: 86 },     // 10 columnas (2 años)
            'egreso': { inicio: 87, fin: 96 },         // 10 columnas (3 años)
            'cuarto': { inicio: 97, fin: 106 },        // 10 columnas (4 años)
            'usaer': { inicio: 107, fin: 116 },        // 10 columnas
            'nextj': { inicio: 117, fin: 126 },        // 10 columnas
            'ormisma': { inicio: 127, fin: 136 },      // 10 columnas
            'orotra': { inicio: 137, fin: 146 },       // 10 columnas
            'orpais': { inicio: 147, fin: 156 },       // 10 columnas
            'ortotal': { inicio: 157, fin: 166 }       // 10 columnas
        };
