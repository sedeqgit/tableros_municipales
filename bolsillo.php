...
function subnivel($link, $titulo_fila, $ini_ciclo, $str_consulta, $filtro_extra, $filtro_pub, $filtro_priv)
{
	...
	$subnivel_pub = rs_consulta($link, $str_consulta, $ini_ciclo, $filtro_pub);
	$subnivel_priv = rs_consulta($link, $str_consulta, $ini_ciclo, $filtro_priv);
...
function mostrar_tabla_munic_usq($link, $filtro_pub, $filtro_priv)
{
...
<BODY>
	...
	mostrar_tabla_munic_usq($link, $filtro_pub, $filtro_priv);
