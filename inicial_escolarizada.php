...
<HEAD>
    ...
    <TITLE>Inicial Escolarizado</TITLE>
    <style>
        .filtro-container {
            margin: 15px 0;
            padding: 10px;
...
<BODY>
    <div class="filtro-container">
        ...
        <select id="columnaFilter">
            ...
            <option value="primero">Lactante</option>
            <option value="segundo">Maternal</option>
            <option value="tercero">Preescolar</option>
    ...
    function mostrar_subnivel($css, $ini_ciclo, $cv_mun, $municipio, $subnivel, $esc, $alum, $doc, $grp, $aula, $disc, $hl, $glact, $gmat, $gpree, $egre, $usaer, $nextj, $ormisma, $orotra, $orpais, $ortotal)
    {
        ...
        echo "<TD VALIGN='center' CLASS='" . $css . "'>INICIAL ESCOLARIZADO</TD>";
    ...
    function prim_qr($dato, $subnivel, $ini_ciclo, $cv_mun)
    {
        ...
        if ((strcmp($dato, "ALUMNO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(V398 + V414)AS totales,
											SUM(v390+v406)AS h,SUM(v394+v410)AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_alum = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(V183 + V184)AS totales,
											SUM(v183)AS h,SUM(v184)AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "DOCENTE")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_doc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(V509+V516+V523+V511+V518+V525+V785+V510+V517+V524+V512+V519+V526+V786)AS totales,
					SUM(V509+V516+V523+V511+V518+V525+V785)AS h,
					SUM(V510+V517+V524+V512+V519+V526+V786)AS m
											FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_doc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(V211 + V212)AS totales,
											SUM(v211)AS h,SUM(v212)AS m
											FROM nonce_pano_" . $ini_ciclo . ".ini_ind_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "GRUPO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_gpr = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(V402 + V418)AS totales 
											FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_gpr = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(V100)AS totales 
											FROM nonce_pano_" . $ini_ciclo . ".ini_ind_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "AULA")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_aula = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v735+v746+v757)AS cat1,
											SUM(v740+v751+v762)AS cat2,SUM(v745+v756+v757)AS cat3
											FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_aula = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v432)AS cat1,
											SUM(v432)AS cat2,SUM(v432)AS cat3
											FROM nonce_pano_" . $ini_ciclo . ".ini_ind_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "DISCAP")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_disc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(V383)AS totales,
											SUM(v381)AS h,SUM(v382)AS m
											FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_disc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v710+v711)AS totales,
											SUM(v710)AS h,SUM(v711)AS m
											FROM nonce_pano_" . $ini_ciclo . ".ini_ind_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "HL")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_hl = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v50+v96)AS totales,
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_hl = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(V323+V330+V337+V344+V350+ V356) AS totales,
											SUM(0)AS h,SUM(0)AS m 		
											FROM nonce_pano_" . $ini_ciclo . ".ini_ind_" . $ini_ciclo . " 
											WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        /**==========================================================================================  
                                                                                                                                                                                                                          =========  GRADOS
                                                                                                                                                                                                                          ==========================================================================================*/
        if ((strcmp($dato, "LACTANTE")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v398)AS totales,
										SUM(v390)AS h,SUM(v394)AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_alum = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control, 0 AS totales,
										0 AS h,0 AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        if ((strcmp($dato, "MATERNAL")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v414)AS totales,
										SUM(v406)AS h,SUM(v410)AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "PREESCOLAR")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v478)AS totales,
										SUM(v466)AS h,SUM(v472)AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "EGRESO")) == 0) {
            ...
            if ((strcmp($subnivel, "IND")) == 0) {
                $qr_prim_ind_egre = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,0 AS totales,
										0 AS h, 0 AS m
										FROM nonce_pano_" . $ini_ciclo . ".ini_ind_" . $ini_ciclo . " 
										WHERE cv_estatus_captura = 0 AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
        ...
        if ((strcmp($dato, "USAER")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_usaer = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v179)AS totales,
											SUM(v177)AS h,SUM(v178)AS m
											FROM nonce_pano_" . $ini_ciclo . ".ini_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
    ...
    function primaria_estadistica($link, $ini_ciclo)
    {
        ...
        while ($row_lista_muni = pg_fetch_assoc($rs_lista_muni)) {
            ...
            $g1ro_gral = prim_hm($link, "LACTANTE", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $g2do_gral = prim_hm($link, "MATERNAL", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            $g3ro_gral = prim_hm($link, "PREESCOLAR", "GRAL", $ini_ciclo, $cv_mun, $municipio);
            ...
            mostrar_subnivel("datos_subnivel", $ini_ciclo, $cv_mun, $municipio, "GRAL", $esc_gral, $alum_gral, $doc_gral, $grp_gral, $aula_gral, $disc_gral, $hl_gral, $g1ro_gral, $g2do_gral, $g3ro_gral, $egre_gral, $usaer_gral, $nextj_gral, $ormisma_gral, $orotra_gral, $orpais_gral, $ortotal_gral);
            ...
            $g1ro_ind = prim_hm($link, "LACTANTE", "IND", $ini_ciclo, $cv_mun, $municipio);
            $g2do_ind = prim_hm($link, "MATERNAL", "IND", $ini_ciclo, $cv_mun, $municipio);
            $g3ro_ind = prim_hm($link, "PREESCOLAR", "IND", $ini_ciclo, $cv_mun, $municipio);
            ...
            mostrar_subnivel("datos_subnivel", $ini_ciclo, $cv_mun, $municipio, "IND", $esc_ind, $alum_ind, $doc_ind, $grp_ind, $aula_ind, $disc_ind, $hl_ind, $g1ro_ind, $g2do_ind, $g3ro_ind, $egre_ind, $usaer_ind, $nextj_ind, $ormisma_ind, $orotra_ind, $orpais_ind, $ortotal_ind);

            $tot_esc_muni = prim_conteo_muni($cv_mun, $municipio, $esc_gral, $esc_ind);
            ...
            mostrar_subnivel("total_muni", $ini_ciclo, $cv_mun, $municipio, "TOT", $tot_esc_muni, $tot_alum_muni, $tot_doc_muni, $tot_grp_muni, $tot_aula_muni, $tot_disc_muni, $tot_hl_muni, $tot_g1ro_muni, $tot_g2do_muni, $tot_g3ro_muni, $tot_egre_muni, $tot_usaer_muni, $tot_nextj_muni, $tot_ormisma_muni, $tot_orotra_muni, $tot_orpais_muni, $tot_ortotal_muni);
        }
    }
    ...
    <script>
        ...
        const columnasIndices = {
            ...
            'primero': { inicio: 57, fin: 66 },        // 10 columnas (Lactante)
            'segundo': { inicio: 67, fin: 76 },        // 10 columnas (Maternal)
            'tercero': { inicio: 77, fin: 86 },        // 10 columnas (Preescolar)
            'egresados': { inicio: 87, fin: 96 },      // 10 columnas
            'usaer': { inicio: 97, fin: 106 },         // 10 columnas
            'nextj': { inicio: 107, fin: 116 },        // 10 columnas
            'ormisma': { inicio: 117, fin: 126 },      // 10 columnas
            'orotra': { inicio: 127, fin: 136 },       // 10 columnas
            'orpais': { inicio: 137, fin: 146 },       // 10 columnas
            'ortotal': { inicio: 147, fin: 156 }       // 10 columnas
        };
