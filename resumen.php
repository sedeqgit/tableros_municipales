                                ...
                                <div class="usaer-desglose-detallado">
                                    ...
                                    <div class="usaer-sostenimiento-grid">
                                        ...
                                        <div class="usaer-sostenimiento-card publico-card">
                                            ...
                                            <div class="usaer-dato-grupo">
                                                <div class="numero-principal">
                                                    <?php echo number_format($datosUSAER['tot_doc_pub'], 0, '.', ','); ?>
                                                    personal
                                                </div>
                                                <div class="porcentaje">
                                        ...
                                        <div class="usaer-sostenimiento-card privado-card">
                                            ...
                                            <div class="usaer-dato-grupo">
                                                <div class="numero-principal">
                                                    <?php echo number_format($datosUSAER['tot_doc_priv'], 0, '.', ','); ?>
                                                    personal
                                                </div>
                                                <div class="porcentaje">
                                    ...
                                    <div class="usaer-personal-section">
                                        ...
                                        <div class="sexo-grid">
                                            ...
                                            <div class="hombres-card">
                                                ...
                                                <div class="numero-principal">
                                                    <?php echo number_format($datosUSAER['doc_h_pub'], 0, '.', ','); ?>
                                                    Público
                                                </div>
                                                <div class="porcentaje">
                                                ...
                                                <div class="numero-principal">
                                                    <?php echo number_format($datosUSAER['doc_h_priv'], 0, '.', ','); ?>
                                                    Privado
                                                </div>
                                                <div class="porcentaje">
                                            ...
                                            <div class="mujeres-card">
                                                ...
                                                <div class="numero-principal">
                                                    <?php echo number_format($datosUSAER['doc_m_pub'], 0, '.', ','); ?>
                                                    Público
                                                </div>
                                                <div class="porcentaje">
                                                ...
                                                <div class="numero-principal">
                                                    <?php echo number_format($datosUSAER['doc_m_priv'], 0, '.', ','); ?>
                                                    Privado
                                                </div>
                                                <div class="porcentaje">
                                    ...
                                    <section class="bottom-footer2 page-editor__disabled-area">
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div
                                                    class="col-md-4 col-sm-12 col-12 text-md-right text-center fin-div">
                                                    <div class="social-links">
                                                        <ul>
                                                            ...
                                                            <li class="social_"><a
                                                                    href="https://www.youtube.com/user/GobQro"
                                                                    target="_blank"><svg
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        viewbox="0 0 640 640"><!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                                                        <path fill="#ffffff"
                                                            ...
                                                            <li class="social_"><a href="tel:4422117070"
                                                                    target="_blank"><svg
                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                        viewbox="0 0 640 640"><!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                                                                        <path fill="#ffffff"
