...
// =============================================================================
// EXPORTACIÓN DE SECCIONES HTML COMPLETAS
// =============================================================================
...
function exportarSeccionPNG(idSeccion) {
        ...
        const opciones = {
            ...
            onclone: function(clonedDoc) {
                ...
                if (clonedElement) {
                    ...
                    clonedElement.classList.remove('animate-fade', 'delay-1', 'delay-2', 'delay-3');
        ...
        html2canvas(elemento, opciones).then(canvas => {
            try {
                ...
                canvas.toBlob(function(blob) {
                    ...
                    enlace.href = url;
                    enlace.download = `analisis-matricula-${idSeccion}-${fecha}.png`;
                    document.body.appendChild(enlace);
                    enlace.click();
                    document.body.removeChild(enlace);
    ...
    }, 300); // Delay de 300ms para asegurar que los estilos se apliquen
}
...
function exportarSeccionPDF(idSeccion) {
    ...
    // Primero capturar con html2canvas y luego crear el PDF manualmente
    // Esto da más control sobre el proceso
    ...
    setTimeout(() => {
        ...
        const opcionesCanvas = {
            ...
            onclone: function(clonedDoc) {
                ...
                if (clonedElement) {
                    ...
                    // Simplificar el header para mejor renderizado
                    const header = clonedElement.querySelector('.matricula-header');
                    if (header) {
                        // Reemplazar gradiente con color sólido
        ...
        html2canvas(elemento, opcionesCanvas).then(canvas => {
            try {
                ...
                // Descargar PDF
                const fecha = new Date().toISOString().slice(0, 10);
                pdf.save(`analisis-matricula-${idSeccion}-${fecha}.pdf`);
...
// Hacer disponibles las funciones de exportación de secciones globalmente
