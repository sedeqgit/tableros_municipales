...
-- Ciclo 2023-2024, Municipio de Corregidora
...
WITH datos_por_control AS (
    ...
    SELECT 'Inicial (Escolarizado)' as tipo_educativo,
        CASE
            WHEN control = 'PUBLICO' THEN 'Público'
            WHEN control = 'PRIVADO' THEN 'Privado'
            ELSE 'Otros'
    ...
    WHERE cv_motivo = 0
        AND c_nom_mun = 'CORREGIDORA'
    GROUP BY control
) -- RESULTADO FINAL AGREGADO POR TIPO EDUCATIVO Y SOSTENIMIENTO
