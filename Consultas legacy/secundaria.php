...
<BODY>
    ...
    function mostrar_subnivel($css, $ini_ciclo, $cv_mun, $municipio, $subnivel, $esc, $alum, $doc, $grp, $aula, $disc, $hl, $g1ro, $g2do, $g3ro, $g4to, $g5to, $g6to, $egre, $usaer, $nextj, $ormisma, $orotra, $orpais, $ortotal)
    {
        ...
        echo "<TD VALIGN='center' CLASS='" . $css . "'>SECUNDARIA</TD>";
    ...
    function prim_qr($dato, $subnivel, $ini_ciclo, $cv_mun)
    {
        ...
        if ((strcmp($dato, "ALUMNO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v340)AS totales,
										SUM(v306+v314)AS h,SUM(v323+v331)AS m
										FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_alum = "SELECT cv_mun,c_nom_mun AS MUNICIPIO,subcontrol,control, SUM(v257)AS totales,
        ...
        if ((strcmp($dato, "DOCENTE")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_doc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v1401)AS totales,
											SUM(V1297+V1303+V1307+V1309+V1311+V1313)AS h,SUM(V1298+V1304+V1308+V1310+V1312+V1314)AS m
											FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_doc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v386)AS totales,
        ...
        if ((strcmp($dato, "GRUPO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_gpr = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v341)AS totales
											FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "AULA")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_aula = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v1421)AS cat1,
											SUM(v1426)AS cat2,SUM(v1431)AS cat3
											FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_aula = "SELECT cv_mun,c_nom_mun AS MUNICIPIO,subcontrol,control, SUM(v386)AS cat1,
											SUM(v384)AS cat2,SUM(v385)AS cat3
											FROM nonce_pano_" . $ini_ciclo . ".sec_comuni_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "DISCAP")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_disc = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v582)AS totales,
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_disc = "SELECT cv_mun,c_nom_mun AS MUNICIPIO,subcontrol,control,SUM(v311)AS totales,
											SUM(v309)AS h,SUM(v310)AS m
											FROM nonce_pano_" . $ini_ciclo . ".sec_comuni_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "HL")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_hl = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v344)AS totales,
											SUM(v342)AS h,SUM(v343)AS m
											FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "PRIMERO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v219)AS totales,
										SUM(v185+v193)AS h,SUM(v202+v210)AS m
										FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_alum = "SELECT cv_mun,c_nom_mun AS MUNICIPIO,subcontrol,control, SUM(v139)AS totales,
										SUM(v105+v113)AS h,SUM(v122+v130)AS m
										FROM nonce_pano_" . $ini_ciclo . ".sec_comuni_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "SEGUNDO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v260)AS totales,
										SUM(v228+v236)AS h,SUM(v244+v252)AS m
										FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_alum = "SELECT cv_mun,c_nom_mun AS MUNICIPIO,subcontrol,control, SUM(v179)AS totales,
										SUM(v147+v155)AS h,SUM(v163+v171)AS m
										FROM nonce_pano_" . $ini_ciclo . ".sec_comuni_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "TERCERO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_alum = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v296)AS totales,
										SUM(v268+v275)AS h,SUM(v282+v289)AS m
										FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_alum = "SELECT cv_mun,c_nom_mun AS MUNICIPIO,subcontrol,control, SUM(v214)AS totales,
										SUM(v186+v193)AS h,SUM(v200+v207)AS m
										FROM nonce_pano_" . $ini_ciclo . ".sec_comuni_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "EGRESO")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_egre = "SELECT cv_mun,c_nom_mun AS municipio, subcontrol,control, SUM(v79)AS totales,
										SUM(v78)AS h,SUM(v78)AS m
										FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
            ...
            if ((strcmp($subnivel, "COMU")) == 0) {
                $qr_prim_comu_egre = "SELECT cv_mun,c_nom_mun AS MUNICIPIO,subcontrol,control, SUM(v75)AS totales,
        ...
        if ((strcmp($dato, "USAER")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_usaer = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v378)AS totales,
											SUM(v376)AS h,SUM(v377)AS m
											FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "NEXTJ")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_nextj = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v609)AS totales,
											SUM(v607)AS h,SUM(v608)AS m
											FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
											WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
											GROUP BY cv_mun,c_nom_mun,subcontrol,control
											ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "ORMISMA")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v133+V135)AS totales,
										SUM(v133)AS h,SUM(v135)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "ORPAIS")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v137+V138)AS totales,
										SUM(v137)AS h,SUM(v138)AS m 
										FROM nonce_pano_" . $ini_ciclo . ".sec_gral_" . $ini_ciclo . " 
										WHERE (cv_estatus_captura = 0 OR cv_estatus_captura = 10) AND cv_mun='" . $cv_mun . "' 
										GROUP BY cv_mun,c_nom_mun,subcontrol,control
										ORDER BY cv_mun,c_nom_mun,subcontrol,control;";
        ...
        if ((strcmp($dato, "ORTOTAL")) == 0) {
            if ((strcmp($subnivel, "GRAL")) == 0) {
                $qr_prim_gral_orig = "SELECT cv_mun,c_nom_mun AS municipio,subcontrol,control,SUM(v139+V140)AS totales,
    ...
    function primaria_estadistica($link, $ini_ciclo)
    {
        ...
        while ($row_lista_muni = pg_fetch_assoc($rs_lista_muni)) {
            ...
            // GRAL - Mantener estos bloques pero eliminar 4to, 5to y 6to
            ...
            // Crear objetos vacíos para los grados eliminados
            $g4to_gral = sin_datos_hm($cv_mun, $municipio);
            $g5to_gral = sin_datos_hm($cv_mun, $municipio);
            $g6to_gral = sin_datos_hm($cv_mun, $municipio);
            ...
            // Para evitar errores, vamos a crear un objeto vacío para ind
            $esc_ind = sin_datos_conteo($cv_mun, $municipio);
            $alum_ind = sin_datos_hm($cv_mun, $municipio);
            $doc_ind = sin_datos_hm($cv_mun, $municipio);
            $grp_ind = sin_datos_conteo($cv_mun, $municipio);
            $aula_ind = sin_datos_categ($cv_mun, $municipio);
            $disc_ind = sin_datos_hm($cv_mun, $municipio);
            $hl_ind = sin_datos_hm($cv_mun, $municipio);
            $g1ro_ind = sin_datos_hm($cv_mun, $municipio);
            $g2do_ind = sin_datos_hm($cv_mun, $municipio);
            $g3ro_ind = sin_datos_hm($cv_mun, $municipio);
            $g4to_ind = sin_datos_hm($cv_mun, $municipio);
            $g5to_ind = sin_datos_hm($cv_mun, $municipio);
            $g6to_ind = sin_datos_hm($cv_mun, $municipio);
            $egre_ind = sin_datos_hm($cv_mun, $municipio);
            $usaer_ind = sin_datos_hm($cv_mun, $municipio);
            $nextj_ind = sin_datos_hm($cv_mun, $municipio);
            $ormisma_ind = sin_datos_hm($cv_mun, $municipio);
            $orotra_ind = sin_datos_hm($cv_mun, $municipio);
            $orpais_ind = sin_datos_hm($cv_mun, $municipio);
            $ortotal_ind = sin_datos_hm($cv_mun, $municipio);

            // COMU - Mismos cambios que en GRAL
            ...
            // Crear objetos vacíos para los grados eliminados
            $g4to_comu = sin_datos_hm($cv_mun, $municipio);
            $g5to_comu = sin_datos_hm($cv_mun, $municipio);
            $g6to_comu = sin_datos_hm($cv_mun, $municipio);
            ...
            // Calcular los totales municipales
    ...
    function sin_datos_conteo($cv_mun, $municipio)
    {
        $prim_conteo_detalle = [
            "cv_mun" => $cv_mun,
            "municipio" => $municipio,
    ...
    <script>
        ...
        const columnasIndices = {
            ...
            // Eliminar estas líneas y ajustar los índices siguientes
            // 'cuarto': { inicio: 87, fin: 96 },         // 10 columnas
            // 'quinto': { inicio: 97, fin: 106 },        // 10 columnas
            // 'sexto': { inicio: 107, fin: 116 },        // 10 columnas
            'egresados': { inicio: 87, fin: 96 },      // 10 columnas (ajustado)
            'usaer': { inicio: 97, fin: 106 },         // 10 columnas (ajustado)
            'nextj': { inicio: 107, fin: 116 },        // 10 columnas (ajustado)
            'ormisma': { inicio: 117, fin: 126 },      // 10 columnas (ajustado)
            'orotra': { inicio: 127, fin: 136 },       // 10 columnas (ajustado)
            'orpais': { inicio: 137, fin: 146 },       // 10 columnas (ajustado)
            'ortotal': { inicio: 147, fin: 156 }       // 10 columnas (ajustado)
        };
